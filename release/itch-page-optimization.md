...
4. Confirm the embedded GIFs load from GitHub raw URLs, or upload the files in `release/gifs/` manually through the itch editor.
5. Publish the devlog from `release/itch-devlog-launch.md`.
6. Search itch.io for `Minefield Beachhead` after publishing and verify the result card.
7. Ask real early players for ratings/comments only after they play.
